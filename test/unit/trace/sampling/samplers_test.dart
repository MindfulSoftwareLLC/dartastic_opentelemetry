...
void main() {
  ...
  group('RateLimitingSampler', () {
    test('limits sampling rate', () async {
      final sampler = RateLimitingSampler(10, timeWindow: Duration(milliseconds: 100)); // 10 per second
      var sampledCount = 0;
    ...
    test('replenishes tokens over time', () async {
      final sampler = RateLimitingSampler(10, timeWindow: Duration(milliseconds: 100));
