...
void main() {
  group('Histogram Extended Tests', () {
    ...
    test('Histogram supports different number types', () async {
      ...
      final doubleMetric = metrics.firstWhere((m) => m.name == 'double-histogram');
      ...
      expect(doubleMetric.points.first.histogram().sum, equals(4.25)); // 1.5 + 2.75
    ...
    test('Histogram with custom boundaries', () async {
      ...
      final boundaries = [1.0, 5.0, 10.0, 25.0, 50.0, 100.0, 250.0, 500.0, 1000.0];
