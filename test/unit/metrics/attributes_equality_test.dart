...
void main() {
  group('Attributes as Map keys', () {
    ...
    test('Attributes equality works for Map lookups', () {
      ...
      expect(map.containsKey(attrs1), isTrue, reason: "Map should contain the exact same key instance");
      expect(map.containsKey(attrs2), isTrue, reason: "Map should recognize equivalent keys");
