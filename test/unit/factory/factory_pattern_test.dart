...
void main() {
  group('Factory Pattern', () {
    ...
    test('Factory creates correct attribute types', () {
      ...
      expect(attrs.get('str.key'), equals('value'));
      expect(attrs.get('int.key'), equals(42));
    });
    ...
    test('Resource creation through factory', () {
      ...
      expect(resource.attributes.get('service.name'), equals('my-service'));
      expect(resource.attributes.get('service.version'), equals('1.0.0'));
    });
