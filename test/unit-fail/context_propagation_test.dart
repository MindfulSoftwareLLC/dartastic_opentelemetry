...
void main() {
  ...
  final testTimeout = isIsolatedRun ? Timeout(Duration(seconds: 60)) : null;
  ...
  group('Context Propagation', () {
    ...
    setUp(() async {
      ...
      await Future.delayed(isIsolatedRun
    ...
    tearDown(() async {
      ...
      await Future.delayed(
          isIsolatedRun ? Duration(seconds: 1) : Duration(milliseconds: 50));
    ...
    test('handles attributes across context boundaries', () async {
      ...
      await collector.waitForSpans(1,
          timeout:
              isIsolatedRun ? Duration(seconds: 10) : Duration(seconds: 5));
