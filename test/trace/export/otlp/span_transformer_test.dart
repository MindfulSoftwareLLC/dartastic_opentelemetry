...
Span createTestSpan({
  ...
  if (endTime != null) {
    ...
    span.end(endTime: startTime.add(Duration(seconds: 1)));
  }
  ...
  group('OtlpSpanTransformer', () {
    test('transforms basic span correctly', () {
      ...
      final span = createTestSpan(
        name: 'test-span',
        startTime: timestamp,
        endTime: timestamp.add(Duration(seconds: 1)),
        attributes: {
          'key': 'value',
        },
      ...
      expect(
        ...
        equals(timestamp.add(Duration(seconds: 1)).microsecondsSinceEpoch * 1000),
      );
    ...
    test('transforms span events correctly', () {
      ...
      final eventTime = startTime.add(Duration(milliseconds: 100));
