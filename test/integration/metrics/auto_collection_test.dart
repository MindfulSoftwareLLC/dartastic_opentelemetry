...
class MockSystemMetricsCollector {
  ...
  int _totalMemoryBytes = 8 * 1024 * 1024 * 1024; // 8 GB
  ...
  int _diskTotalBytes = 512 * 1024 * 1024 * 1024; // 512 GB
...
void main() {
  group('Auto Collection Integration Tests', () {
    ...
    test('Metrics are auto-collected on collection interval', () async {
      ...
      var initialMetrics = metricReader.getCollectedMetrics();
    ...
    test('Resource detection and custom attributes', () async {
      ...
      final resourceMeterProvider = OTel.meterProvider() as MeterProvider;
