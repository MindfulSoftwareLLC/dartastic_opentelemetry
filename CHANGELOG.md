...
## [0.9.6] - 2026-07-18
  Stable-channel republication of 1.1.0-beta.9 — identical content
  (depends on api 0.9.1, itself the republication of 1.0.0-rc.1).
  Prefer ^1.1.0-beta.9 going forward.
